...
>
  <Plus className="size-4" />
            ...
            {threads.map((thread) => {
              ...
              return (
                <li
                  key={thread.id}
                  className={cn(
                    "group flex items-center gap-1 border-2 border-transparent px-1",
                ...
                >
                  ...
                  <button
                    ...
                    className="flex size-6 shrink-0 items-center justify-center text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 hover:text-destructive focus-visible:opacity-100"
                  >
      ...
      {/* ✅ Markets Section */}
      <div className="mt-4 border-t-2 border-sidebar-border pt-3 px-2">
        <button
          type="button"
        ...
        >
          <span className="text-pixel text-[9px] text-muted-foreground">
            Markets
          </span>
        ...
        {resourcesOpen && (
          <div className="mt-1 space-y-0.5">
            ...
            <button
              ...
              className="flex w-full items-center px-2 py-1.5 text-left text-xs text-muted-foreground hover:text-foreground"
            >
...
function ResourcePlaceholder({ label }: { label: string }) {
  return (
    <span
      aria-disabled="true"
      title={`${label} destination has not been configured yet`}
      className="flex w-full cursor-default items-center px-2 py-1.5 text-xs text-muted-foreground"
    >
      <span className="mr-2 text-primary">·</span>
      {label}
    </span>
